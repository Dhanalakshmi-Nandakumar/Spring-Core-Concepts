...
public class MathController {
    ...
    public MathController(MathService mathService,ApplicationContext context) {
   ...
   private String portNumber;
    ...
    public void init() {
    	...
    	log.info("MathController initialized with MathService dependency: {}", mathService);
    	log.info("MathController constructor called with ApplicationContext dependency: {}", context);
        log.info("MathController initialized with Random dependency: {}", random);
    }
}
